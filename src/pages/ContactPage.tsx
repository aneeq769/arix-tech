...
export function ContactPage() {
  ...
  const fieldSx = {
    "& .MuiOutlinedInput-root": { background: "rgba(0,212,255,.03)", borderRadius: "10px", fontSize: ".92rem", "& fieldset": { borderColor: BORDER, borderWidth: "1px" }, "&:hover fieldset": { borderColor: BHI }, "&.Mui-focused fieldset": { borderColor: C, boxShadow: `0 0 0 3px rgba(0,212,255,.08)` } },
